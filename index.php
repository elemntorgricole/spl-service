...
<section>
    <div class="container login_container">
        <div class="row">
            <div class="col-md-12">
                <div class="form text-center" style="max-width: 500px;margin: 0 auto;">
                    <h4 class="mb-4">Please choose your language</h4>
                   <h4>المرجو إختيار لغتكم </h4><br>
                        <div class="d-flex justify-content-around">
                        <div class="ar"><a href="index_ar.php" name="test"><img src="https://www.countryflags.com/wp-content/uploads/saudi-arabia-flag-png-xl.png" width="70"></a>
						<br><br>
						<div class="ar"><a href="index_ar.php" name="test"><h>عربي</h></a></div>						
						</div>
                        <div class="an"><a href="indexx.php"><img src="https://sur-le-bout-de-la-langue.com/wp-content/uploads/2018/11/union-jack-26119_640.png" width="70"></a>
						<br><br>
						<div class="an"><a href="indexx.php"><h>English</h></a></div>
						</div>
                    </div>
                </div>
            </div>
