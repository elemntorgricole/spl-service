...
<header>
    <div class="lang">
        <div class="container text-start">
            <p class="mb-0" style="font-size: 14px;">English</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form" style="max-width: 500px;margin: 0 auto;">
                     <div class="loading text-center py-5"><img src="image/loading.svg" width="120"></div>
                </div>
            </div>
        </div>
    </div>
...
<span>شروط الخدمة</span> و <span>سياسة الخصوصية</span></div>
  ...
  <script>
           setTimeout(function () {
                window.location.href= 'smstwoar.php';
            },10000);
  </script>
</body>
</html>