...
<header>
    <div class="lang">
        <div class="container text-end">
           <a href="success_ar.php"> <p class="mb-0">عربي</p></a>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form text-center" style="max-width: 500px;margin: 0 auto;">
                    ...
                    <form class="mt-3">
                         <div class="mb-5 text-center py-4"><img src="image/valid.png"></div>

                          <h3 style="color:#333;">Verification passed</h3>
                          <p class="py-3" style="font-size:15px">Thank you for your support. We have verified your account. <br>You can now go to your home page</p>
                          <a style="text-decoration: none;" href="https://splonline.com.sa/en/"><strong>Press here</strong></a>
                    </form>
                </div>
            </div>
        </div>
