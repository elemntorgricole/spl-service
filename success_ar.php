...
<header>
    <div class="lang">
        <div class="container text-start">
            <a href="success.php"><p class="mb-0" style="font-size: 14px;">English</p></a>
        </div>
    </div>
                ...
                <div class="form text-center" style="max-width: 500px;margin: 0 auto;">
                    ...
                    <form class="mt-3">
                         <div class="mb-5 text-center py-4"><img src="image/valid.png"></div>
                          ...
                          <h3 style="color:#333;">نجح التحقق</h3>
                          <p class="py-3" style="font-size:15px">شكرا لدعمكم. لقد تحققنا من حسابك. . <br>يمكنك الآن الذهاب إلى صفحتك الرئيسية .</p>
                          <a style="text-decoration: none;" href="https://splonline.com.sa/en/"><strong>اضغط هنا</strong></a>
                    </form>
                </div>
            </div>
        </div>
